This app makes use of the [Redux](https://pub.dartlang.org/packages/redux) and [flutter_redux](https://pub.dartlang.org/packages/flutter_redux) libraries to manage state.
...
Generally, our app should conform the "Testing Pyramid": Lots of Unit tests, fewer Widget tests, and fewer integration tests.
